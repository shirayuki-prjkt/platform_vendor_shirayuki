...
# Overlays
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/shirayuki/overlay
...
PRODUCT_COPY_FILES += \
    vendor/shirayuki/prebuilt/common/bin/sysinit:$(TARGET_COPY_OUT_SYSTEM)/bin/sysinit


# Vendor specific init files
$(foreach f,$(wildcard vendor/shirayuki/prebuilt/common/etc/init/*.rc),\
...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/shirayuki/build/tools/50-shirayuki.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-shirayuki.sh \
    vendor/shirayuki/build/tools/backuptool.sh:$(TARGET_COPY_OUT_SYSTEM)/install/bin/backuptool.sh \
    vendor/shirayuki/build/tools/backuptool.functions:$(TARGET_COPY_OUT_SYSTEM)/install/bin/backuptool.functions \
    vendor/shirayuki/prebuilt/common/bin/clean_cache.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/clean_cache.sh

# system mount
PRODUCT_COPY_FILES += \
    vendor/shirayuki/prebuilt/common/bin/system-mount.sh:install/bin/system-mount.sh
...
PRODUCT_COPY_FILES += \
    vendor/shirayuki/config/permissions/backup.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/backup.xml

# Enable Android Beam on all targets
PRODUCT_COPY_FILES += \
    vendor/shirayuki/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.software.nfc.beam.xml

# Default and google apps privapp permissions
PRODUCT_COPY_FILES += \
    vendor/shirayuki/config/permissions/privapp-permissions-shirayuki.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-shirayuki.xml \
    vendor/shirayuki/config/permissions/privapp-permissions-custom.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-custom.xml

# Fonts
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/shirayuki/prebuilt/fonts,$(TARGET_COPY_OUT_SYSTEM)/fonts) \
