...
ALARM_PATH := vendor/shirayuki/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/shirayuki/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/shirayuki/prebuilt/common/media/audio/ringtones
