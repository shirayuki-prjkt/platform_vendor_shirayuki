...
cp -r vendor/shirayuki/utils/$TARGET_PRODUCT/skins $ANDROID_PRODUCT_OUT
cat vendor/shirayuki/utils/$TARGET_PRODUCT/start_emulator_image.sh | sed -e "s/vbmeta/$DIGEST/" > $ANDROID_PRODUCT_OUT/start_emulator_image.sh
