...
function breakfast()
{
    target=$1
<<<<<<< HEAD
    SHIRAYUKI_DEVICES_ONLY="true"
=======
    shirayuki_DEVICES_ONLY="true"
>>>>>>> 1e0fb305f52f2e0aa155e4823c13b6b7f1424866
    unset LUNCH_MENU_CHOICES
    add_lunch_combo full-eng
       for f in $(test -d $ANDROID_BUILD_TOP/vendor/shirayuki && \
            find -L $ANDROID_BUILD_TOP/vendor/shirayuki  -maxdepth 4 -name 'vendorsetup.sh' 2>/dev/null | sort); do
            echo "including $f"
            . $f
        done
    unset f
...
<<<<<<< HEAD
            # This is probably just the ShirayukiProject model name
=======
            # This is probably just the shirayuki model name
>>>>>>> 1e0fb305f52f2e0aa155e4823c13b6b7f1424866
            lunch shirayuki_$target-userdebug
        fi
    fi
    return $?
}
...
function repopick() {
    T=$(gettop)
    $T/vendor/shirayuki/build/tools/repopick.py $@
}
