...
=======
    default_gerrit = 'http://gerrit.shirayukios.com'
...
=======
        name = ("shirayuki-project/")+project.get('name')
>>>>>>> 1e0fb305f52f2e0aa155e4823c13b6b7f1424866
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit shirayuki', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch shirayuki', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
