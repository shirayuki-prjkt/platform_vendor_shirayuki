...
custom_dependencies = "shirayuki.dependencies"
org_manifest = "ShirayukiProject-Devices"  # leave empty if org is provided in manifest
org_display = "ShirayukiProject-Devices"  # needed for displaying
